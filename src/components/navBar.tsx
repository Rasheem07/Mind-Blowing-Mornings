...
import { Facebook, Linkedin, Search, SearchIcon, Twitter } from 'lucide-react'
...
export default function NavBar() {
  ...
  return (
    <div className='backdrop-blur-sm min-h-[70px] opacity-95 absolute top-0 inset-x-0 z-10 border-b border-zinc-200 max-w-[100vw] overflow-hidden' style={{background: "rgba(255, 255, 255, 0.7"}}>
        ...
        <button className='bg-[#F47D31] hover:bg-orange-400/90 transition-colors text-white py-2.5 px-5 rounded-lg shadow-md uppercase'>Log in</button>
        </MaxWidthWrapper>
    </div>
  )
}
